...
public class BASS {
    ...
    public static native boolean BASS_ChannelGet3DAttributes(int i, Integer num, Float f, Float f2, Integer num2, Integer num3, Float f3);
    ...
    public static native boolean BASS_ChannelGetAttribute(int i, int i2, Float f);
    ...
    public static native boolean BASS_Get3DFactors(Float f, Float f2, Float f3);
    ...
    public static native int BASS_RecordGetInput(int i, Float f);
    ...
    public static native int BASS_StreamCreate(int i, int i2, int i3, int i4, Object obj);
    ...
    public static native void BASxS_Apply3D();
}
