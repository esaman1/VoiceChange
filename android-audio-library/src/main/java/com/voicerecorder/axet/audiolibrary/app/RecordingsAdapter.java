...
//    public View imgEmpty;
    ...
    public static class RecordingHolder extends RecyclerView.ViewHolder {
        ...
        public SeekBar bar;
        private final ImageView trash, imgTrimAudio, play, star;
...
//            dur = v.findViewById(R.id.recording_duration);
...
//    public void setEmptyView(View imgEmpty) {
...
//        if (imgEmpty == null) return;
//        if (empty.getWrappedAdapter().getItemCount() == 0) {
...
//                h.trash.setColorFilter(Color.GRAY);
                ...
                RxView.clicks(h.trash).throttleFirst(1, TimeUnit.SECONDS).subscribe(v -> delete.run());
...
//        });
    ...
    private void startTrimAudioActivity(Uri uri) {
        try {
            ...
            try {
                intent = new Intent(context, Class.forName("com.voicerecorder.audiorecorder.soundrecorder.activities.MainActivity"));
